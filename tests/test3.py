...
async def test_scraper():
    ...
    os.makedirs("/workspaces/AkiraAI/Dataset/Summarization/input_markdown/raw_markdown/documentation", exist_ok=True)

    file_counter =46   # Start the file naming with 1
    ...
    async for doc in scraper.fetch_urls_with_browser(urls=url_list):
        ...
        if html_content:
            ...
            filename = os.path.join("/workspaces/AkiraAI/Dataset/Summarization/input_markdown/raw_markdown/documentation", f"doc_{file_counter}.md")
            file_counter += 1
