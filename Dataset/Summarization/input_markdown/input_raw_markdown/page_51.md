Overview of Generative AI on Vertex AI | Google Cloud[![](https://www.gstatic.com/devrel-devsite/prod/v5ab6fd0ad9c02b131b4d387b5751ac2c3616478c6dd65b5e931f0805efa1009c/cloud/images/cloud-logo.svg)](/)
...
* Open models
  ...
  + [Open LLaMa](/vertex-ai/generative-ai/docs/open-models/use-llama)
...
* Evaluation
  ...
  + [Quickstart: Gen AI evaluation workflow](/vertex-ai/generative-ai/docs/models/evaluation-quickstart)
...
* Video generation
  + [Generate videos using text or image prompts](/vertex-ai/generative-ai/docs/video/generate-videos)
* Embeddings
...
* Troubleshoot
  + Troubleshoot LangChain on Vertex AI
    ...
    - [Troubleshoot developing an application](/vertex-ai/generative-ai/docs/reasoning-engine/troubleshooting/develop)
...
* Generative AI on Vertex AI code samples
  ...
  + [Enhance a product image by modifying the background content with Imagen](/vertex-ai/generative-ai/docs/samples/generativeaionvertexai-imagen-edit-image-product-image)
  ...
  + [Remove image content using mask-based inpainting with Imagen](/vertex-ai/generative-ai/docs/samples/generativeaionvertexai-imagen-edit-image-inpainting-remove-mask)
...
* Legacy docs
  ...
  + PaLM 2 API (text/chat)
    ...
    - [Send text prompt requests](/vertex-ai/generative-ai/docs/text/test-text-prompts)
    - [Get batch responses for text](/vertex-ai/generative-ai/docs/text/batch-prediction-genai)
    - [Ground responses](/vertex-ai/generative-ai/docs/grounding/ground-language-models)
    - [Send chat prompt requests](/vertex-ai/generative-ai/docs/chat/test-chat-prompts)
    - Tune PaLM 2 models
      * [Tune and distill PaLM models](/vertex-ai/generative-ai/docs/models/tune-text-models)
      * [Use supervised tuning](/vertex-ai/generative-ai/docs/models/tune-text-models-supervised)
      * [Use RLHF tuning](/vertex-ai/generative-ai/docs/models/tune-text-models-rlhf)
      * [Distill text models](/vertex-ai/generative-ai/docs/models/distill-text-models)
    - [Get a list of tokens](/vertex-ai/generative-ai/docs/compute-token)
    - [Get token count](/vertex-ai/generative-ai/docs/get-token-count)
    - [Stream responses](/vertex-ai/generative-ai/docs/learn/streaming)
    - [Configure safety attributes](/vertex-ai/generative-ai/docs/configure-safety-attributes-palm)
  + Codey API (code)
    - [Overview of code models](/vertex-ai/generative-ai/docs/code/code-models-overview)
    - [Send code chat requests](/vertex-ai/generative-ai/docs/code/test-code-chat-prompts)
    - [Send code generation requests](/vertex-ai/generative-ai/docs/code/test-code-generation-prompts)
    - [Tune Codey models](/vertex-ai/generative-ai/docs/models/tune-code-models)
    - [Get batch code predictions](/vertex-ai/generative-ai/docs/code/batch-prediction-genai-code)
  + Reference
    - [Codey for code generation](/vertex-ai/generative-ai/docs/model-reference/code-generation)
    - [Codey for code chat](/vertex-ai/generative-ai/docs/model-reference/code-chat)
    - [PaLM 2 for text](/vertex-ai/generative-ai/docs/model-reference/text)
    - [PaLM 2 for chat](/vertex-ai/generative-ai/docs/model-reference/text-chat)
  + [Quotas and limits](/vertex-ai/generative-ai/docs/legacy/legacy-quotas)
  + [Security controls](/vertex-ai/generative-ai/docs/legacy/legacy-security)
  + [Pricing](/vertex-ai/generative-ai/docs/legacy/legacy-pricing)
...
**Note:** If you're looking for a way to use Gemini directly from your mobile and web apps, see the [Vertex AI in Firebase SDKs](https://firebase.google.com/docs/vertex-ai) for Android, Swift, web, and Flutter apps.
